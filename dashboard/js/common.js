...
if ($('#select_zone').length > 0) {
    $(".js-example-basic-single").select2();
}

//show block

$('.modal_i_icon').hover(function() {
    $(this).siblings('.show_i_block').css('display', 'block');
}, function() {
   $(this).siblings('.show_i_block').css('display', 'none');
});
